...
public partial class EditPageViewModel : ObservableObject
{
    ...
    public EditPageViewModel(IOverlayService overlayService, IContentDialogService contentDialogService)
    {
        ...
        AltitudeXReferences = Enum.GetValues<AltitudeXReference>();
    }
